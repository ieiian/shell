...
echo "  |_| |____/|_____|"
echo " =================="
echo -e "\033[96mTSE 一键脚本工具 v1.0.0 （支持Ubuntu，Debian，Centos系统）\033[0m"
echo "------------------------"
echo "1.  系统信息"
echo "2.  系统更新"
echo "3.  系统清理"
    ...
    4)
        ...
        case $sub_choice in
            1)
                ...
                echo "alias $kuaijiejian='curl -sS -O https://raw.githubusercontent.com/ieiian/sh/main/tse.sh && chmod +x tse.sh && ./tse.sh'" >> ~/.bashrc
